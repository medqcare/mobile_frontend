        ...
        <KeyboardAvoidingView style={styles.container} behavior={'padding'} enabled>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
				...
				<View style={styles.header}>
					<Text style={styles.headerText}>Silahkan masukan password baru anda</Text>
				</View>
                ...
                <View style={styles.inputContainer}>
                    <View style={styles.inputTopContainer}>
                        ...
                        {/* Password Error */}
                        {
                            ...
                            <Text style={{ color: 'red' }}>Password must be at least 5 characters</Text>
                        }
                    </View>
                    ...
                    <View style={styles.inputBottomContainer}>
                        <View style={styles.input}>
                         ...
                         {
                            form.password !== null && form.password !== form.confirmPassword &&
                            <Text style={{ color: 'red' }}>Confirm password does not match</Text>
                        }
                    </View>
                    ...
                    <View style={styles.buttonContainer}>
                        {/* {!countDown && */}
                            ...
                            >   
                            <View>                               
                                <Text style={{ fontSize: 18, color: '#FFF' }}>Ganti Password</Text>
                            </View>   
                            </TouchableOpacity>
                        {/* } */}
                    </View>
