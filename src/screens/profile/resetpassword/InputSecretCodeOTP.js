...
const InputSecretCodeOTP = (props) => {
    ...
    async function validation(){
        ...
        if(secretCode.length < 4){
            ToastAndroid.show('Mohon ketik kode yang anda terima di SMS', ToastAndroid.SHORT)
        }
        else if(!isNumber){
        ...
        <View style={style.container}>
            ...
            <View style={{justifyContent: 'space-between', flex: 1,}}>
                <View style={style.TopContainer}>
                    ...
                    <Text style={style.MessageBottomText}> Masukan kode verifikasi yang telah dikirimkan ke nomor </Text>
