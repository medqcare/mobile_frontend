    ...
    <View style={{ flex: 1 }}>
      <View style={styles.Container}>
        ...
        <View style={styles.DetailDokter}>
          ...
          {data.facility && data.facility[0].facilityEstPrice && (
            <View>
        ...
        >
          <View style={{ alignItems: 'flex-end' }}>
            <TouchableOpacity onPress={() => setModalKonfirmasi(true)}>
              <OptionButton />
            </TouchableOpacity>
          </View>
          <TouchableOpacity
          ...
          >
            {loadingGetDoctor ? (
              <ActivityIndicator color={WHITE_PRIMARY} size={Platform.OS === "android" ? 14 : 'small'}/>
            ) : (
              <Text
                style={{
                  color: WHITE_PRIMARY,
        ...
        >
          <View style={viewModalP.container}>
            ...
            <View style={viewModalP.patient}>
              ...
              >
                <View>
                  <Text style={viewModalP.name}>Hapus Dari Favorit</Text>
                </View>
              </TouchableOpacity>
            </View>
          </View>
