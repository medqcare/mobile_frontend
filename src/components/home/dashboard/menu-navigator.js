  ...
  return (
    <View style={style.container}>
      ...
      <TouchableOpacity style={style.borderIcon}
        ...
        <Image navigation={navigation} source={require('../../../assets/png/ic_klinik.png')} style={{width: 24, height: 24}} />
        <Text
          style={{ marginTop: 10, fontSize:12, color: '#B5B5B5' }}>Klinik</Text>
      </TouchableOpacity>
      <View style={{
        backgroundColor: '#0C6292',
        height: '80%',
      ...
      <TouchableOpacity style={style.borderIcon}
        ...
        <Scan />
        <Text style={{ marginTop: "1%", }}>Scan</Text>
      </TouchableOpacity> */}
    </View>
  );
};
