              ...
              <View style={styles.card}>
                ...
                <View style={styles.contentBox}>
                  <Text style={styles.textContent}>
                    {data.examination.anamnesa}ksjhdfljksdhfjhjjjjjjkshdfjshdfkjhsdfkhsdjfhsjfhskhfsdhkjfhskjfhsjd
                  </Text>
                </View>
                <View style={styles.item}>
                ...
                <View style={styles.contentBox}>
                  <Text style={styles.textContent}>
                    {data.examination.physicalExam}ksjhdfljksdhfjhjjjjjjkshdfjshdfkjhsdfkhsdjfhsjfhskhfsdhkjfhskjfhsjd
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.contentHeader}>
              ...
              <View style={styles.card}>
                <View style={styles.item}>
                  ...
                  <Text style={styles.textItem}>{data.vitalSign.height}</Text>
                </View>
                <View style={styles.item}>
                  <Text style={styles.textItem}>Berat</Text>
                  <Text style={styles.textItem}>{data.vitalSign.weight}</Text>
                </View>
                <View style={styles.item}>
                  <Text style={styles.textItem}>Systole</Text>
                  <Text style={styles.textItem}>{data.vitalSign.systole}</Text>
                </View>
                <View style={styles.item}>
                  <Text style={styles.textItem}>Dyastole</Text>
                  <Text style={styles.textItem}>{data.vitalSign.dyastole}</Text>
                </View>
                <View style={styles.item}>
                ...
                data.order.map((item) => {
                  return (
                    <View style={styles.card} key={item._id}>
                      <View style={styles.item}>
                        <Text style={{...styles.textItem, fontSize: 15, color: '#DDDDDD'}}>{item.facilityDest}</Text>
                      </View>
            ...
            <View style={styles.contentHeader}>
              ...
              <View style={styles.card}>
                ...
                <View style={styles.item}>
                  ...
                  <Text style={styles.textItem}>{data.examination.ICD}</Text>
                </View>
                <View style={styles.item}>
