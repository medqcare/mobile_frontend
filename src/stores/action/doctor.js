...
export function searchAllDoctors(currentPage, location, doctors, filterQuery){
    return async (dispatch) => {
        try {
            if(filterQuery){
                console.log(`Searching doctor with filter: `)
...
export function searchDoctorBySpecialist(currentPage, specialist, doctors){
    return async (dispatch) => {
        try {
            console.log('Application is trying to search doctor by specialist')
